...
tags:
  ...
  - HTML
---
While using <strong>HTML</strong> it can be very handy to have an easy way to remember how to use HTML tags properly and how to apply them. MDN provides you with an extended [HTML documentation](https://developer.mozilla.org/en-US/docs/Web/HTML/Element) as well as a deep instructional [HTML how-to](https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto). However, in many cases we just need some quick hints as we go. That's the whole purpose of the cheatsheet, to give you some quick accurate ready to use code snippets for common usages.
